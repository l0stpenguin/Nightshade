#include "NightshadeUIKitController.h"
#import "SparkAppListTableViewController.h"


@implementation NightshadeUIKitController

- (NSArray *)specifiers {
	if (!_specifiers) {
		_specifiers = [[self loadSpecifiersFromPlistName:@"NightshadeUIKitSettings" target:self] retain];
	}
