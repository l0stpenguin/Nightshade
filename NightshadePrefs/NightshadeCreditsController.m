#include "NightshadeCreditsController.h"

@implementation NightshadeCreditsController

- (NSArray *)specifiers {
	if (!_specifiers) {
		_specifiers = [[self loadSpecifiersFromPlistName:@"NightshadeCredits" target:self] retain];
	}
