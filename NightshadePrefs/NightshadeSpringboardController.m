#include "NightshadeSpringboardController.h"
#import "SparkAppListTableViewController.h"


@implementation NightshadeSpringboardController

- (NSArray *)specifiers {
	if (!_specifiers) {
		_specifiers = [[self loadSpecifiersFromPlistName:@"NightshadeSpringboardSettings" target:self] retain];
	}
...
-(void)selectApps{
    SparkAppListTableViewController* s = [[SparkAppListTableViewController alloc] initWithIdentifier:@"com.dylanduff.nightshadeprefs" andKey:@"whitelistedApps"];
